    ...
    <div class="row">
        ...
        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="row" style="padding-left:20px;padding-bottom:20px;">
                <input type="button" class="btn btn-default bg-color-blueDark txt-color-white" id="btnAddCorporate" name="btnAddCorporate" value="Add New Corporate" style="margin-right:20px;"/>
            </div>
            ...
            <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-2"  data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-deletebutton="false">
                <header>
                    ...
                    <span><h2>&nbsp;Search Corporate / Panel Company</h2></span>
                </header>
                        ...
                        <div id="selectCriTab" class="tab-content">
                            <div class="tab-pane fade active in padding-5 no-padding-bottom" id="selectCriTab_s1">
                                <table id="tblSearch" class="selection-criteria">
                                    <tr>
                                        <td width="15%">Corporate Name:</td>
                                        <td width="100%">                                            
                                            <input type="text" id="txtName" name="txtName"  placeholder="--Enter Corporate Name--" class="searchbox-text" />
                                        </td>
                                    </tr> 
                                    <tr>
                                         <td colspan="6">
                ...
                <div>             
                    ...
                    <div class="widget-body">                           
                        <div class="table-responsive">
                            <div id="cjqgridCorporateList"></div>
                            <table id="jqgridCorporateList" class="table table-striped table-bordered"  ></table>
                            <div id="pjqgridCorporateList"></div>
                        </div>
                    </div>
                    <!-- end widget content -->
                </div>
...
<script type="text/javascript">
    ...
    function Search() {      
        $("#wid-id-1").show();
        $("#jqgridCorporateList").jqGrid('setGridParam', {
            postData: {
                SFC: 'GET_CORPORATE_LIST', 
                NAME: $('#txtName').val()
            }
